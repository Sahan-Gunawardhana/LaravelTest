...
<div class="container mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <!-- About Section -->
            <div>
                <h3 class="text-xl font-bold mb-4">About Paw Some</h3>
                <p class="text-gray-400">
                    Paw Some is your one-stop destination for all your pet’s needs. From food to toys, we have everything to make your pet’s life happier and healthier.
                </p>
            </div>
            ...
            <div>
                ...
                <ul>
                    ...
                    <li class="mb-2"><a href="#" class="text-gray-400 hover:text-white">Shop</a></li>
            ...
            <div>
                ...
                <p class="text-gray-400 mb-2">
                    <strong>Email:</strong> info@pawsome.com
                </p>
                ...
                <div class="flex space-x-4">
                    <a href="#" class="text-gray-400 hover:text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.723-.951.563-2.005.974-3.127 1.195-.897-.956-2.173-1.554-3.594-1.554-2.719 0-4.924 2.205-4.924 4.923 0 .385.043.761.127 1.124-4.092-.205-7.72-2.165-10.148-5.144-.424.729-.667 1.577-.667 2.476 0 1.708.869 3.215 2.19 4.098-.807-.026-1.566-.247-2.229-.616v.062c0 2.386 1.698 4.374 3.953 4.825-.414.112-.849.171-1.296.171-.317 0-.627-.031-.928-.088.627 1.956 2.444 3.379 4.6 3.419-1.685 1.319-3.808 2.106-6.115 2.106-.398 0-.79-.023-1.175-.069 2.179 1.397 4.768 2.211 7.548 2.211 9.057 0 14.012-7.506 14.012-14.011 0-.213-.005-.425-.014-.637.961-.694 1.795-1.562 2.457-2.549z" />
                        </svg>
                    </a>
                    <a href="#" class="text-gray-400 hover:text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M19.615 3.184h-15.23c-1.076 0-1.951.875-1.951 1.951v13.731c0 1.076.875 1.951 1.951 1.951h15.231c1.076 0 1.951-.875 1.951-1.951v-13.731c0-1.076-.875-1.951-1.951-1.951zm-9.615 13.5h-2.5v-7.5h2.5v7.5zm-1.25-8.617c-.801 0-1.449-.648-1.449-1.449s.648-1.449 1.449-1.449 1.449.648 1.449 1.449-.648 1.449-1.449 1.449zm9.365 8.617h-2.5v-4.267c0-.951-.02-2.173-1.324-2.173s-1.528 1.035-1.528 2.105v4.335h-2.5v-7.5h2.403v1.023h.034c.335-.635 1.153-1.3 2.374-1.3 2.539 0 3.009 1.672 3.009 3.845v3.932z" />
                        </svg>
                    </a>
                    <a href="#" class="text-gray-400 hover:text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                            <path d="M12 2.163c-5.421 0-9.837 4.417-9.837 9.837 0 4.455 3.066 8.168 7.117 9.489-.098-.82-.187-2.085.039-2.98.209-.855 1.344-5.457 1.344-5.457s-.344-.687-.344-1.701c0-1.591.923-2.779 2.072-2.779.978 0 1.451.734 1.451 1.613 0 .983-.628 2.451-.953 3.819-.272 1.128.577 2.048 1.711 2.048 2.053 0 3.63-2.297 3.63-5.604 0-2.929-2.104-4.977-5.114-4.977-3.488 0-5.537 2.612-5.537 5.309 0 .961.372 1.993.837 2.552.093.111.106.207.077.318-.084.335-.273 1.066-.312 1.215-.049.186-.158.226-.367.137-1.358-.56-2.207-2.321-2.207-3.742 0-3.039 2.207-5.838 6.374-5.838 3.352 0 5.556 2.419 5.556 5.033 0 3.446-1.923 6.02-4.75 6.02-1.014 0-1.967-.528-2.291-1.154l-.624 2.378c-.226.871-.836 1.963-1.247 2.632.94.293 1.933.451 2.963.451 5.42 0 9.837-4.417 9.837-9.837s-4.417-9.837-9.837-9.837z" />
                        </svg>
                    </a>
                </div>
            </div>
        ...
        <div class="mt-8 text-center text-gray-400">
            <p>&copy; 2024 Paw Some. All rights reserved.</p>
            <p class="text-sm">Making your pet’s life happier and healthier, one paw at a time.</p>
        </div>
    </div>
</footer>
</html>